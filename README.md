...
require("agent99").setup({
    ...
    post_edit = {                -- what symbol edit tools do and report after applying
        ...
        settle_ms = 300,         -- quiet time after the last publish, or after a server acknowledged the edit without one
